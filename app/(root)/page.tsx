  ...
  return (
    ...
    >
      <div className="text-black text-center flex gap-4 flex-col items-center w-80 md:w-fit lg:w-fit  absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
        <h1 className="lg:text-6xl md:text-5xl text-5xl font-semibold"><BlurFade>Kyu nhi ho raha<RoughNotation type="underline" show={true}> GSoC?</RoughNotation></BlurFade></h1>
